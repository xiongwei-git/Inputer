...
public class ArgotManager {
  ...
  public int insert(Argot argot) {
    ...
    Uri uri = getContentResolver().insert(ArgotContentProvider.baseURI, contentValues);
    String result = "-1";
  ...
  public ArrayList<Argot> query(String selection, String selectionArgs) {
    ...
    Cursor cursor = null;
    try {
      cursor = getContentResolver().query(ArgotContentProvider.baseURI, ArgotDb.FIELD_NAME,
          selection + " LIKE ? ", new String[] { "%" + selectionArgs + "%" },
          "usage_count DESC LIMIT 3");
  ...
  public ArrayList<Argot> queryAll(String selection, String[] selectionArgs, String sortOrder) {
    ArrayList<Argot> results = new ArrayList<>();
    Cursor cursor = null;
    try {
      cursor =
          getContentResolver().query(ArgotContentProvider.baseURI, ArgotDb.FIELD_NAME, selection,
  ...
  public void delete(long id) {
    getContentResolver().delete(ArgotContentProvider.baseURI, "_id = ?",
  ...
  public int update(Argot record) {
    ...
    return getContentResolver().update(ArgotContentProvider.baseURI, contentValues, "_id = ?",
