...
public class FloatWindowView extends FrameLayout {
  ...
  public void initFloatBtnView(FloatBtnType type, OnClickListener onClickListener) {
    ...
    if (null == mFloatingActionButton) mFloatingActionButton = new FloatingActionButton(mContext);
  ...
  private void updateViewPosition() {
    ...
    SharePreData sharePreData =
        new FavorAdapter.Builder(mContext).build().create(SharePreData.class);
