package com.mrxiong.argot.debug;
...
public class DebugDbActivity extends BaseActivity implements View.OnClickListener,CompoundButton.OnCheckedChangeListener {
  ...
  private com.mrxiong.argot.store.cp.ArgotManager manager;
  private int state = 0;
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    manager = new com.mrxiong.argot.store.cp.ArgotManager(this);
