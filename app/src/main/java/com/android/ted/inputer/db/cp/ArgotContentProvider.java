...
public class ArgotContentProvider extends ContentProvider {
  public static final Uri baseURI =
      Uri.parse("content://com.android.ted.inputer.db.cp.ArgotContentProvider/ARGOT");
  public static final UriMatcher uriMatcher = new UriMatcher(UriMatcher.NO_MATCH);
  private BaseSQLiteHelper baseSQLiteHelper;

  static {
    uriMatcher.addURI("com.android.ted.inputer.db.cp.ArgotContentProvider", "ARGOT", 10);
    uriMatcher.addURI("com.android.ted.inputer.db.cp.ArgotContentProvider", "ARGOT/#", 20);
  }
