...
import com.android.ted.inputer.view.AutoFitRecyclerView;
import com.android.ted.inputer.view.TItemDecoration;
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    fab.setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View view) {
        startActivity(new Intent(MainActivity.this, ArgotRowViewActivity.class));
      }
    });
